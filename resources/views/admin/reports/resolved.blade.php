...
@section('main-content')
    <div class="container-fluid">
        ...
        <div class="row m-1">
            <div class="col-12 ">
                <h4 class="main-title">Resolved Report</h4>
                <ul class="app-line-breadcrumbs mb-3">
                    ...
                    <li class="active">
                        <a href="#" class="f-s-14 f-w-500">Resolved</a>
                    </li>
                </ul>
            </div>
        </div>
                    ...
                    <div class="col-sm-6">
                        <div class="card ticket-card bg-light-primary">
                            <div class="card-body">
                                ...
                                <p class="f-s-16">All Resolved Report</p>
                                <div class="d-flex justify-content-between align-items-center">
                                    <h3 class="text-primary-dark">{{ $resolved_reports->count() }}</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="card ticket-card bg-light-info">
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <h3 class="text-info-dark">{{ $resolved_reports->where('reported_type', 'user')->count() }}</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="card ticket-card bg-light-success">
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <h3 class="text-success-dark">{{ $resolved_reports->where('reported_type', 'course')->count() + $resolved_reports->where('reported_type', 'lesson')->count() + $resolved_reports->where('reported_type', 'resource')->count()}}</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="card ticket-card bg-light-warning">
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <h3 class="text-warning-dark">{{ $resolved_reports->where('reported_type', 'forum_post')->count() + $resolved_reports->where('reported_type', 'forum_reply')->count() }}</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="table-responsive app-scroll app-datatable-default">
                            <table class="w-100 display" id="ticketdatatable">
                                ...
                                <tbody>
                                    @forelse($resolved_reports as $report)
                                    <tr>
                                        {{-- <td>
                                            <div class="checkbox-wrapper">
                                                <label class="check-box m-0">
