...
@section('main-content')
    <div class="container-fluid">
        ...
        <div class="row m-1">
            <div class="col-12 ">
                <h4 class="main-title">MCQ Quiz</h4>
                <ul class="app-line-breadcrumbs mb-3">
                    ...
                    <li class="active">
                        <a href="#" class="f-s-14 f-w-500">MCQ Quiz</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="faq-header p-3">
            ...
            <p class="text-muted mt-2">
                AI-powered quiz generator. Enter a topic and let StudySama create 5 Multiple Choice Questions for you.
            </p>

            <div class="app-form search-div mt-4">
                <form action="{{ route('ai.mcq_generated') }}" method="POST" class="ajax-upload-form">
                @csrf
                    <div class="input-group mb-3">
                        ...
                        <button class="btn btn-primary b-r-left rounded-end" type="submit" id="button-addon1"><i class="ti ti-brain pe-1"></i> Generate Quiz</button>
                    </div>
                </form>
            </div>
        </div>
