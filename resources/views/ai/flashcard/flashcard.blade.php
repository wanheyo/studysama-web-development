...
@section('main-content')
    <div class="container-fluid">
        ...
        <div class="row m-1">
            <div class="col-12 ">
                <h4 class="main-title">Flashcard</h4>
                <ul class="app-line-breadcrumbs mb-3">
                    ...
                    <li class="active">
                        <a href="#" class="f-s-14 f-w-500">Flashcard</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="faq-header p-3">
            ...
            <p class="text-muted mt-2">
                AI-powered flashcard generator. Enter a topic and let StudySama create multiple flashcards for you.
            </p>
            ...
            <div class="app-form search-div mt-4">
                ...
                @csrf
                    <div class="input-group mb-3">
                        ...
                        <button class="btn btn-primary b-r-left rounded-end" type="submit" id="button-addon1"><i class="ti ti-brain pe-1"></i> Generate Flashcard</button>
                    </div>
                </form>
            </div>
        </div>
