<div class="row">
    @foreach ($courses->where('role_id', 1) as $course)
        <div class="col-xxl-4 col-md-6 col-sm-6 mb-4">
            <div class="card overflow-hidden h-100 {{ $course->status == 2 ? 'dashed-4-danger' : '' }}">
                <div class="card-body p-0 d-flex flex-column">
                    ...
                    <div class="p-3 flex-grow-1">
                        ...
                        <div class="d-flex justify-content-between align-items-center mt-2">
                            ...
                            @foreach ($course->topics as $topic)
                                <span class="badge bg-primary small text-truncate d-inline-block" style="max-width: 70%; overflow: hidden; text-overflow: ellipsis;">#{{ $topic->name }}</span>
                            @endforeach
                        </div>
                    ...
                    <div class="p-2 border-top bg-primary-light">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <!-- Right: Badge -->
                            @if($course->status == 2)
                                <span class="badge bg-danger" data-bs-placement="top" data-bs-toggle="tooltip"
                                title="This course is under review by the admin, user cannot view or join it.">Under Review</span>
                            @endif
                        </div>
                    </div>
                </div>
